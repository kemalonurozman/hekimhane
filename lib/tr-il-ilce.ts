// Türkiye 81 il ve ilçeleri — panel il/ilçe seçici için.
// İl adları IL_KONUM (lib/il-koordinatlari.ts) ile aynı yazımda.
...
export const IL_LISTE = Object.keys(IL_ILCE);
export const ILCELER = (il?: string | null): string[] => (il && IL_ILCE[il]) ? IL_ILCE[il] : [];
